...
| `max_points`      |            `int`            | Maximum number of points displayed to facilitate visualization. Pass `max_points <= 0` to use all points without any subsampling                                                                                                                                                                                                                                                                                                      |
...
| `display`         |           `bool`            | Whether to display the plotly figure. Setting to `False` will return the plotly figure object without displaying it, allowing to save compute and time if the end goal is to save it to disk or to display later                                                                                                                                                                                                                      |
